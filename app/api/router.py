...
from app.api.routes import auth, bank_accounts, branches, capital, companies, company_settings, customers, health, loan_settings, loans, payments, payroll, plans, print_settings, reports, routes, subscriptions, tour_progress, users
...
api_router.include_router(tour_progress.router, prefix="/tour-progress", tags=["tour-progress"])
